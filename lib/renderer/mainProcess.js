...
const cancelWindowButton = document.getElementById("cancel");
const payWindowButton = document.getElementById("pay");
...
cancelWindowButton.addEventListener("click", event => {
...
payWindowButton.addEventListener("click", event => {
